...
def ticket_entrada_cena(request, pk):
    ...
    return render(request, 'ticket_cena.html', context)
...
def ticket_boleto(request, pk):
    ...
    return render(request, 'ticket_boleto.html', context)
...
def ticket_dorsal(request, pk):
    ...
    return render(request, 'ticket_dorsal.html', context)
...
def ticket_concierto(request, pk):
    ...
    return render(request, 'ticket_concierto.html', context)
...
def verificar_ticket_cena(request, pk):
    ...
    return render(request, 'verificar_ticket.html', context)
